...
Kirigami.ApplicationWindow {
    ...
    Component { 
        ...
        Kirigami.Page {
            id: rootEditorView
            title: i18nd("mauikitfilebrowsing", "Edit")
            leftPadding: 0
            rightPadding: 0
                    ...
                    Kirigami.Action {
                        ...
                        onTriggered: {
                            if (!imageDoc.save()) {
                                ...
                                msg.text = i18nd("mauikitfilebrowsing", "Unable to save file. Check if you have the correct permission to edit this file.")
                                msg.visible = true;
                            }
                        }
                        visible: imageDoc.edited
            ...
            FileDialog {
                id: fileDialog
                title: i18nd("mauikitfilebrowsing", "Save As")
                ...
                onAccepted: {
                    if (imageDoc.saveAs(fileDialog.fileUrl)) {;
                        ...
                        msg.text = i18nd("mauikitfilebrowsing", "You are now editing a new file.")
                        msg.visible = true;
                    } else {
                        msg.type = Kirigami.MessageType.Error
                        msg.text = i18nd("mauikitfilebrowsing", "Unable to save file. Check if you have the correct permission to edit this file.")
                ...
                contentItem: Kirigami.ActionToolBar {
                    ...
                    actions: [
                        Kirigami.Action {
                            ...
                            text: rootEditorView.resizing ? i18nd("mauikitfilebrowsing", "Cancel") : i18nc("@action:button Crop an image", "Crop");
